...
- Proficiency in at least one machine learning framework: Hardware-Software Co-Design, High Performance Computing, 
ML Hardware Acceleration (e.g. GPU/TPU/RDMA) or ML Framework (e.g. TensorFlow/PyTorch)
*/}